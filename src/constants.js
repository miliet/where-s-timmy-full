...
languageArabic [0]  = "أين هي تيمي؟";
languageArabic [1]  = "لوثي فتاة لها دمية من قماش متعددة الألوان. اسمها تيمي!";
languageArabic [2]  = "تتناول لوثي وجبة الإفطار مع تيمي وتنام معها في المساء.";
languageArabic [3]  = "كل يوم، عندما تعود من المدرسة، تذهب الى الغرفة لتُقبل تيمي.";
languageArabic [4]  = "- أواه! أواه!  تيمي غير موجودة! -لوثي تبكي. - ماما!، بابا! تيمي غير موجودة في الغرفة! أين هي؟ ماذا حدث لها؟";
languageArabic [5]  = " سألتها أمها أين تركت تيمي هذا الصباح فأجابتها لوثي بحزن: - في سريري!";
languageArabic [6]  = "- آه لوثي! قالت أمها.- تعالي لنبحث عنها! ولكني أعتقد أن عليك أن تكوني أكثر نظاما.";
languageArabic [7]  = " عندما دخلتا الغرفة تيمي لم تكن موجودة في السرير فبدأت ماما تبحث عنها في الغرفة.";
languageArabic [8]  = " انظري! تيمي موجودة هنا، نصف مخفية ونصف مفقودة! ما رأيك يا لوثي؟";
languageArabic [9]  = " - أنا أحبك يا تيمي- قالت لوثي. منذ الآن وفي كل يوم، لوثي وتيمي تخصصان بعض الوقت لترتيب اللعب.";
